...
planter_one = Product.create(title: 'Vege-patch labels', image: 'stakes.jpg', sub_category_name: 'vege-patch', category: veges)
...
mirror_one = Product.create(title: 'bathroom mirror', image: 'brmirror.jpeg', sub_category_name: 'bath', category: toys)
...
garden_swing = Product.create(title: 'upcycled swinging bench', image: 'gardenswing2.jpeg', sub_category_name: 'garden furniture', category: garden_furniture)
...
birdfeeder = Product.create(title: 'Birdfeeder', image: 'birfeeder1.jpeg', sub_category_name: 'garden accessories', category: garden_accessories)
patio_couch = Product.create(title: 'Veranda couch upcycled', image: 'garden-f.jpeg', sub_category_name: 'garden furniture', category: garden_furniture)
